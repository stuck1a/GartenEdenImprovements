...
function BCUGenericTA:setOnIsValid(func, ...)
  ...
  for i,v in pairs(table.pack(...)) do self.onIsValidArguments[i] = v end
end
...
function BCUGenericTA:setOnUpdate(func, ...)
  ...
  for i,v in pairs(table.pack(...)) do self.onUpdateArguments[i] = v end
end
...
function BCUGenericTA:setOnStart(func, ...)
  ...
  for i,v in pairs(table.pack(...)) do self.onStartArguments[i] = v end
end
...
function BCUGenericTA:setOnStop(func, ...)
  ...
  for i,v in pairs(table.pack(...)) do self.onStopArguments[i] = v end
end
...
function BCUGenericTA:setOnPerform(func, ...)
  ...
  for i,v in pairs(table.pack(...)) do self.onPerformArguments[i] = v end
end
