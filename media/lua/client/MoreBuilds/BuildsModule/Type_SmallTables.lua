if not getMoreBuildInstance then
  require('MoreBuilds/MoreBuilds_ContextMenu')
end
...
MoreBuild.smallTablesMenuBuilder = function(subMenu, player)
  ...
  MoreBuild.neededMaterials = {
    { Material = 'Base.Plank', Amount = 5 },
    { Material = 'Base.Nails', Amount = 4 }
  }
  MoreBuild.neededTools = {'Hammer'}
  local needSkills = { Woodwork = MoreBuild.skillLevel.simpleFurniture }
...
MoreBuild.largeTablesMenuBuilder = function(subMenu, player)
  ...
  MoreBuild.neededMaterials = {
    { Material = 'Base.Plank', Amount = 6 },
    { Material = 'Base.Nails', Amount = 4 }
  }
  MoreBuild.neededTools = {'Hammer'}
  local needSkills = { Woodwork = MoreBuild.skillLevel.complexFurniture }
  for _, _currentList in pairs(_tableData) do
    _sprite = {}
    _sprite.sprite = _currentList[1]
